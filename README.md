...
rewritten, because Codex asks you to review them with `/hooks` whenever their definitions change:
`relay-cli hooks status codex` names the events that are missing, and the setup puts them back.
